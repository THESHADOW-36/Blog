         ...
         <div className='h-100 row'>
            ...
            <div className='p-1 col-3'>
               <div className="d-flex flex-column h-100">
                  ...
                  <div className='bg-dark-subtle w-100 h-50 my-1 rounded d-flex align-items-center justify-content-center' style={{ cursor: "pointer" }} onClick={() => setToggleBtn(true)}>
                     <p className='fs-4 fw-semibold'>Profile</p>
                  </div>
                  <div className='bg-dark-subtle w-100 h-50 mt-1 rounded d-flex align-items-center justify-content-center' style={{ cursor: "pointer" }} onClick={() => setToggleBtn(false)}>
                     <p className='fs-4 fw-semibold'>Add Blog</p>
                  </div>
               </div>
            </div>
