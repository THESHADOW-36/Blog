   ...
   return (
      <div className='profile'>
         <div className='h-100 row'>
            ...
            <div className='p-1 col-xl-3 col-md-12'>
            ...
            <div className='p-1 col-xl-9 col-md-12'>
               <div className='bg-dark-subtle h-100 rounded p-2'>
                  ...
                  <form onSubmit={editUserData}>
                     <div className='row mt-3'>
                        ...
                        <div className='col-xl-6 col-12 d-flex mt-4 mb-2'>
                           <div className='w-100 row align-items-center'>
                              ...
                              <div className='col-1 fs-5 fw-semibold d-none d-sm-block'>:</div>
                     ...
                     <div className='mt-3 mb-2 d-flex justify-content-between px-4 flex-column flex-sm-row'>
                        <button className='btn btn-primary px-5' type='button' onClick={() => setEditBtn(!editBtn)}>Edit</button>
                        <button className='btn btn-primary px-5 mt-3 mt-sm-0' type='submit' disabled={editBtn}>Save</button>
                     </div>
                  </form>
               </div>
            </div>
