      ...
      <div className='profile'>
         <div className='h-100 row'>
            ...
            <div className='p-1 col-3'>
               <div className='bg-dark-subtle w-100 h-100 d-flex flex-column align-items-center rounded p-3'>
                  <div className='proPic rounded-circle mt-5'>
                     <img src={propic} className='w-100 h-100 rounded-circle' alt='' />
                  </div>

                  <p className='fs-4 fw-semibold m-3'>{userData?.firstName} {userData?.lastName}</p>
               </div>
            </div>
               ...
               <div className='bg-dark-subtle h-100 rounded p-2'>
                  ...
                  <form>
                     ...
                     <div className='mt-3 mb-2 d-flex justify-content-between px-4'>
                        ...
                        <button className='btn btn-primary px-5' type='submit' onClick={editUserData} disabled={editBtn}>Save</button>
                     </div>
                  </form>
               </div>
            </div>
